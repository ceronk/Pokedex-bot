// 1/? Queries to improve performance as well as good practices by using GraphQL to refactor the Pokemon Bot (working on it for now).
...
#Due to an error(1) getting sprites, these could be gotten by writing url and using id from info.id, not a good practice at all...
